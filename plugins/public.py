...
from pyrogram.errors import FloodWait, ChannelPrivate, ChannelInvalid, ChatAdminRequired, UsernameInvalid, UsernameNotModified
...
async def run(bot, message):
    ...
    if fromid.text and not fromid.forward_date:
        ...
        if last_msg_id is None:
            return await message.reply_text("**This may be a forwarded message from a group and sent by an anonymous admin. Instead, please send the last message link from the group.**")
    else:
