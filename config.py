...
class Config:
    API_ID = int(environ.get("API_ID", "29726374"))
    ...
    DATABASE_URI = environ.get("DATABASE_URI", "mongodb+srv://ackbot:ackbot@bot.uthcly0.mongodb.net/?retryWrites=true&w=majority&appName=bot")
